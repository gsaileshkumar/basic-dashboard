...
export const getEmployees = (rehire_eligible) => {
	let employees = rehireEligibleEmployees;
	if (rehire_eligible === false) {
		employees = rehireInellgibleEmployees;
	}
	if (rehire_eligible === null) {
		employees = rehireUnknownEmployees;
	}
